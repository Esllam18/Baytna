...
def upgrade() -> None:
    ...
    # ---------------------------------------------------------------
    with op.batch_alter_table("provider_cost_import_batches", recreate="always") as batch:
        batch.add_column(
            sa.Column(
                "review_status",
                sa.String(length=20),
    ...
    # ---------------------------------------------------------------
    with op.batch_alter_table("provider_settlement_batches", recreate="always") as batch:
        batch.add_column(
            sa.Column(
                "operations_status",
                sa.String(length=20),
    ...
    with op.batch_alter_table("operations_incidents", recreate="always") as batch:
