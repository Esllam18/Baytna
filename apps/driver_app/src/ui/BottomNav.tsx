...
const items=[
  ...
  {key:"missions",label:"المهام",icon:"➜",href:"/missions"},
  {key:"history",label:"السجل",icon:"▤",href:"/history"},
] as const;
...
const s=StyleSheet.create({
  ...
  item:{alignItems:"center",flex:1},icon:{fontSize:20,color:colors.muted},label:{fontSize:9,color:colors.muted,marginTop:4},active:{color:colors.orangeDark,fontWeight:"900"},
});
